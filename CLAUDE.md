...
- **Active refactor — the canonical pickup point (transitional).** When in doubt about "what's the next work" during the 2026-05 authoring refactor, read [`docs/phases/2026-05-authoring-refactor.md`](docs/phases/2026-05-authoring-refactor.md) — currently the single self-contained tracking doc for the in-flight authoring-system refactor. It explains every locked decision with rationale and contains the execution log + decision rows for all closeouts. **Status:** all 9 Phase 2 rounds + both Phase 2.5 cycles closed 2026-05-26; only Phase 3 remains. **Once Phase 3 ships, this tracker moves to `docs/archive/2026-05-authoring-refactor.md` and becomes non-authoritative.** Delete this CLAUDE.md bullet when that move happens.
