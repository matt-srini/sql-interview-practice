...
- **Python** — 80 practice (33 easy / 29 medium / 18 hard) + 8 mock-only, data-professional algorithms (sessionization, hash join, DAG cycle detection, critical path, rate limiting, backpressure, edit distance), test-case evaluation
...
| Python | 33 + 0 | 29 + 3 | 18 + 5 | Algorithm function, test cases | `backend/content/python_questions/` |
