...
def test_tc072_mock_only_questions_absent_from_practice_catalog():
    """TC-072: Elite catalog count = 395 practice questions (no mock_only)."""
    ...
    assert total == 395, f"Expected 395 practice questions, got {total} ({sql_count}+{py_count}+{pd_count}+{spark_count})"
