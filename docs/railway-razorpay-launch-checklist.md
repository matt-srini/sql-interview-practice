...
RAZORPAY_PLAN_PRO=
RAZORPAY_PLAN_ELITE=
RAZORPAY_AMOUNT_LIFETIME_PRO=1199900
RAZORPAY_AMOUNT_LIFETIME_ELITE=1999900
...
- Pro monthly
  ...
  - Interval: `1`
  - Amount: `99900` paise if Razorpay asks for subunits, or `999` if it asks for rupees in the UI
- Elite monthly
  - Plan name: `datathink Elite Monthly`
  - Billing period: `Monthly`
  - Interval: `1`
  - Amount: `199900` paise or `1,999` rupees depending on the UI field
