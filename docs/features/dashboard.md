...
- Legacy regression coverage for the original executable-track slice is still deepest in tests; the product and API now operate across all 10 active tracks
