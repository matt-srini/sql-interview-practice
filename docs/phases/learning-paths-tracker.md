...
|---|---|---:|---|
| pandas | `window-and-rolling` | 3 | 32013, 33005, 33088 |
...
- pandas: `customer-analytics` (no analytics-pipeline family)
...
### Pandas (pandas) — 8 patterns (today 6)
...
| 2026-06-08 | **Bucket A.live extended-range (16–20) absorption — 27 orphans into 4 paths.** Authorized expansion under the 16–20 exception policy. Absorbed: `pandas data-cleaning` 15→18 (+3: 33016, 33023, 33038), `statistics applied-stats` 8→18 (+10: 72011–72023, 73002–73027), `experimentation experiment-design-and-power` 10→18 (+8: 91008–91023, 92009–92027), `pyspark spark-memory-and-driver-executor` 6→12 (+6: 41032, 41034, 42010, 43002, 43013, 43046 — under 15, safe-green). All 27 orphans verified to pass validator rule 5 (concept tags align with target path's focus_concepts); zero question-content edits. Orphan totals shift: statistics 16→6, experimentation 22→14, pandas 5→2, pyspark 21→15. `scripts/absorb_bucket_a_extended.py` re-runnable + idempotent. Validator + 19/19 tests pass. |
