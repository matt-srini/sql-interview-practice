...
export const TRACK_CONCEPT_MAP = {
  ...
  'product-sense': ['METRIC SELECTION & GOAL TRANSLATION','GUARDRAIL & COUNTER-METRIC REASONING','METRIC DEFINITION INTEGRITY','BUSINESS-MODEL METRIC FLUENCY','ENGAGEMENT & STICKINESS REASONING','RETENTION & COHORT REASONING','FUNNEL & CONVERSION REASONING','GROWTH & ACQUISITION REASONING','METRIC MOVEMENT DIAGNOSIS','SEGMENTATION & DECOMPOSITION REASONING','REAL-CHANGE VS ARTIFACT','CAUSAL VS CORRELATIONAL JUDGMENT','CONFLICTING-METRIC & TRADE-OFF JUDGMENT','SHIP / NO-SHIP DECISION','METRIC GAMING & ROBUSTNESS','PRODUCT HEALTH & STRATEGIC TRADE-OFFS','PRODUCT CASE STRUCTURING','OPPORTUNITY SIZING & ESTIMATION'],
};
