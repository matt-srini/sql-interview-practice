        ...
        <section className="lp-section ip-hero">
          <div className="lp-inner ip-hero-inner">
            ...
            <p className="ip-hero-sub">
              Data interviews usually test a mix of SQL, data manipulation, statistics, Product Sense, experimentation, systems, modeling, and machine learning. The mix changes by role. Use these pages to see what each role tends to emphasize, how the tracks are weighted, and where to start with a free sample.
            </p>
          </div>
          <button
            type="button"
